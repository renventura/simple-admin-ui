...
namespace RenVentura\SimpleAdminUI\AdminPage;
...
class Admin_Page {
	...
	public function __construct( array $args ) {
		...
		$meta_boxes = new \RenVentura\SimpleAdminUI\RegisterMetaBoxes\Register_Meta_Boxes( $this->slug );
	}
	...
	public function add_page(){
		...
		if ( is_array( $this->help_section ) && isset( $this->help_section['tabs'] ) ) {
			...
			new \RenVentura\SimpleAdminUI\HelpTabs\Help_Tabs( $this->page, $this->help_section['tabs'], $sidebar );
		}
	}
	...
	public function render_page(){ ?>
		 ...
		 <div class="wrap">
			...
			<form name="<?php echo $this->slug; ?>_admin_form" id="<?php echo $this->slug; ?>_admin_form" action="?page=<?php echo $this->slug; ?><?php if ( isset( $_GET['tab'] ) ) echo '&tab=' . $_GET['tab']; ?>&save-settings=true" method="post">
				...
				<div id="poststuff">
					 ...
					 <div id="post-body" class="metabox-holder columns-<?php echo 1 == get_current_screen()->get_columns() ? '1' : '2'; ?>"> 
						...
						<?php do_action( "simple_admin_ui_form_end_{$this->slug}" ); ?>	     					
			...
			<?php do_action( "simple_admin_ui_after_form_{$this->slug}" ); ?>
	...
	public function render_tabs( $current = '' ) {
		...
		if ( ! empty( $this->tabs ) ) : ?>
			...
			<?php do_action( "simple_admin_ui_before_tabs_{$this->slug}" ); ?>
			...
			<h2 class="nav-tab-wrapper">
				...
				<?php foreach ( $this->tabs as $key => $tab ) : ?>
					...
					<a href="<?php echo add_query_arg( 'tab', $key ); ?>" class="nav-tab<?php echo $active; ?>"><?php echo $tab; ?></a>

				<?php endforeach; ?>

			</h2>

			<?php do_action( "simple_admin_ui_after_tabs_{$this->slug}" ); ?>
